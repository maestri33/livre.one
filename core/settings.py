"""
Django settings for Livre.one | Seja Livre ! | Foi para a liberdade que Cristo nos libertou. (Gl5:1a NVT) project.
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="core"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "core_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="core-media")
...
SERVER_EMAIL = env("SERVER_EMAIL", default="noreply@Livre.one")
...
EMAIL_SUBJECT_PREFIX = "[Livre.one | Seja Livre ! | Foi para a liberdade que Cristo nos libertou. (Gl5:1a NVT)] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Livre.one | Seja Livre ! | Foi para a liberdade que Cristo nos libertou. (Gl5:1a NVT)",
    "DESCRIPTION": "Existe um propósito para sua vida, e o fato de você estar lendo isto não é obra do acaso ! Chega ! Chegou a hora de você ser Livre !",
    "VERSION": "0.1.0",
...
WAGTAIL_SITE_NAME = "Livre.one | Seja Livre ! | Foi para a liberdade que Cristo nos libertou. (Gl5:1a NVT) Content"
WAGTAILADMIN_BASE_URL = "http://Livre.one"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Livre.one | Seja Livre ! | Foi para a liberdade que Cristo nos libertou. (Gl5:1a NVT)"),
    "URL": "http://Livre.one",
...
ADMINS = [("Pr. Victor Maestri", "contato@maestri.email")]
